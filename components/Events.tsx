...
const UPCOMING_EVENTS = [
  {
    ...
    title: "Neurotech NCSU Hackathon — Fall 2026",
    description:
      "A continuous overnight hackathon, hands-on with real EEG headsets and live brain data. Headsets provided by IDUN Technologies. Food provided; limited to 100 participants.",
                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className="px-3 py-1 rounded-full text-sm bg-primary text-primary-foreground">
                        {event.status}
                      </span>
                    </div>
                  </div>
